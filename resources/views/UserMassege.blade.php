                ...
                @else
                    <div class="d-flex flex-column gap-3">
                        @foreach($messages as $message)
                            <!-- Message Card -->
                            <div class="card shadow-sm border-0 position-relative @if(!$message->is_read) border-primary border-2 @endif"
                                ...
                                @if(!$message->is_read)
                                    <span
                                        class="position-absolute top-0 start-100 translate-middle badge rounded-pill bg-primary shadow"
