  ...
  <div>
    ...
    <div class="content" style="margin-top: 80px;">
          ...
          <div class="container mt-4">
            <div class="d-flex justify-content-center">
              <form action="{{ route('admin.dashboard') }}" method="GET"
                class="d-flex border rounded-pill shadow-sm px-2" role="search" style="max-width: 300px; width: 100%;">
                <input class="form-control form-control-sm border-0 rounded-pill" type="search" name="search"
      ...
      <div class="card mt-4 shadow" id="view-room-card" style="display: none;">
        <div class="container mt-4">
          <div class="d-flex justify-content-center">
            <form action="{{ route('admin.dashboard') }}" method="GET" class="d-flex border rounded-pill shadow-sm px-2"
              role="search" style="max-width: 300px; width: 100%;">
              <input class="form-control form-control-sm border-0 rounded-pill" type="search" id="roomSearchInput"
                name="room_search" placeholder="Search..." aria-label="Search" value="{{ $roomSearch ?? '' }}">
              <button class="btn btn-sm btn-primary rounded-pill px-3 ms-1" type="submit">Go</button>
            </form>
          </div>
        </div>
